...
static const JNINativeMethod kgwMethods[] = {
...
jbyteArray JNICALL Lyra2REHash(JNIEnv *env, jclass cls, jbyteArray header)
{
    jint Plen = (env)->GetArrayLength(header);
    jbyte *P = (env)->GetByteArrayElements(header, NULL);
	...
	lyra2re2_hash((const char*)P, buf);

    DK = (env)->NewByteArray(32);
    if (DK)
	{
		(env)->SetByteArrayRegion(DK, 0, 32, (jbyte *) buf);
	}
...
static const JNINativeMethod powMethods[] = {
  { "digest_native", "([B)[B", (void*)Lyra2REHash},
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass cls = (env)->FindClass("com/hashengineering/crypto/difficulty/KimotoGravityWell/kgw");
    int r = (env)->RegisterNatives(cls, kgwMethods, 4);

   jclass cls2 = (env)->FindClass("com/hashengineering/crypto/Lyra2RE");
   r = (env)->RegisterNatives(cls2, powMethods, 1);
