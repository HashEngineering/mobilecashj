...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/mobilecash-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "mobilecash/bitcoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "mobilecash/bitcoin-paymentack";
